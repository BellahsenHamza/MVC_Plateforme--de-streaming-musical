...
{
    [CustomValidation(typeof(modifAlbum), "ValiderModif")]
    public class modifAlbum
    {
        public static ValidationResult ValiderModif(modifAlbum m)
        {
            if (m.image != null && m.image.ContentType != "image/jpeg")
            {
